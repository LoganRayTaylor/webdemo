...
import com.stellaweb.webdemo.models.dto.LoginFormDTO;
import com.stellaweb.webdemo.models.dto.RegisterFormDTO;
...
public class AuthenticationController {
    ...
    private static final String userSessionName = "user2";
    ...
    private static void setUserInSession(HttpSession session, User user) {
      session.setAttribute(userSessionName, user.getUsername());
